...
class Currency extends CI_Controller
{
	...
	function getAll()
	{
		$banks = $this->core_model->get_all('currency', null,  array('id', 'ASC'));
		echo $this->load->view('settings/currency/_table', array('banks' => $banks), true);
	}
	function index()
	{
		$data = array(
			...
			'sub_menu_active' => 'currency',
			'currencies' => $this->core_model->get_all('currency', null,  array('id', 'ASC')),
		);
		$this->load->view('settings/currency/index', $data);
	}

	public function create()
	{
		echo $this->load->view('settings/currency/_create', null, true);
	}
