<div class="modal-content">
	<div class="modal-header position-relative">
		<h5 class="modal-title text-info">
			<?= $this->lang->line('show') . ' ' . $this->lang->line('department') ?>
		</h5>
	</div>
			...
			<div class="col-md-12">
				<div class="card mb-3">
					<div class="card-body">
						...
						<div class="row">
							<div class="col-sm-4">
								<h6 class="mb-0 f-w-600"><?= $this->lang->line('manager') ?></h6>
							</div>
							<div class="col-sm-8 text-secondary">
								<?= ($manager) ? $manager->first_name : 'N/A' ?>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal-footer">
		<div class="d-flex justify-content-between w-100">
			...
			<button type="button" class="btn btn-sm btn-outline-secondary"
					onclick="get_modal(<?= $department->id ?>,'department','small','edit')">
