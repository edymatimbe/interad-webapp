<div class="row">
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="check_bank" required list="bankList" value="Millennium BIM">
    </div>

    <div class="form-group col-md-6">
        <label for="check_holder"><?= $this->lang->line('owner') ?><span class="text-danger">&nbsp;*</span></label>
        <input type="text" class="form-control" id="check_holder" required value="Reviva Moze">
    </div>
</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="check_account" value="418517753">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
